...
import com.changdao.website.service.LinksService;
...
public class AdminController extends BaseController {
	...
	public String index(Model model) {
		...
		// 成立天数
		Date blogStart=DateUtil.parse(ChangdaoConst.OPTIONS.get("blog_start").toString());
	...
	public String login(HttpSession session, Model model) {
		User user = (User) session.getAttribute(ChangdaoConst.USER_SESSION_KEY);

		if (user != null) {
			log.info("........"+ChangdaoConst.USER_SESSION_KEY);
	...
	public JsonResult getLogin(@RequestParam(value = "userName") String userName,
		...
		try {
			...
			if (user != null) {
				session.setAttribute(ChangdaoConst.USER_SESSION_KEY, user);
				// 登录成功重置用户状态为正常
