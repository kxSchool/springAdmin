package com.changdao.website.util;
...
public class Commons {
	...
	public static Map<String,String> social(){
		...
		map.put("weibo", ChangdaoConst.OPTIONS.get(prefix+"weibo"));
		map.put("zhihu", ChangdaoConst.OPTIONS.get(prefix+"zhihu"));
		map.put("github", ChangdaoConst.OPTIONS.get(prefix+"github"));
		map.put("twitter", ChangdaoConst.OPTIONS.get(prefix+"twitter"));
		if(StrUtil.isNotEmpty(ChangdaoConst.OPTIONS.get(prefix+"qq"))) {
			map.put("qq", "http://wpa.qq.com/msgrd?v=3&uin="+ChangdaoConst.OPTIONS.get(prefix+"qq")+"&site=qq&menu=yes");
		}
		if(StrUtil.isNotEmpty(ChangdaoConst.OPTIONS.get(prefix+"email"))) {
			map.put("email", "mailto:"+ChangdaoConst.OPTIONS.get(prefix+"email"));
		}
		if("rss_open".equals(ChangdaoConst.OPTIONS.get(prefix+"rss"))) {
				map.put("rss", ChangdaoConst.OPTIONS.get("blog_url")+"/index.xml");
		}
		return map;
	}
}
