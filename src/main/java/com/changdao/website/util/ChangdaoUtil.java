...
public class ChangdaoUtil {
	...
	public static String buildRss(List<ArticleCustom> articles)throws FeedException{
		 ...
		 if(ChangdaoConst.OPTIONS.get("blog_name")==null) {
			 channel.setTitle("");
		 }else {
			 channel.setTitle(ChangdaoConst.OPTIONS.get("blog_name"));
		 }
		 if(ChangdaoConst.OPTIONS.get("blog_url")==null) {
			 channel.setLink("");
		 }else {
			 channel.setLink(ChangdaoConst.OPTIONS.get("blog_url"));
		 }
		 if(ChangdaoConst.OPTIONS.get("blog_url")==null) {
			 channel.setUri("");
		 }else {
			 channel.setUri(ChangdaoConst.OPTIONS.get("blog_url"));
		 }
		 if(ChangdaoConst.OPTIONS.get("seo_describe")==null) {
			 channel.setDescription("");
		 }else {
			 channel.setDescription(ChangdaoConst.OPTIONS.get("seo_describe"));
		 }
		...
		for (int i = 0; i < articles.size(); i++) {
			...
			item.setLink(ChangdaoConst.OPTIONS.get("blog_url")+"/post/"+articles.get(i).getArticleUrl());
